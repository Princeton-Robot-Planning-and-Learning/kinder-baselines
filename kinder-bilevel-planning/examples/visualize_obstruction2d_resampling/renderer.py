"""Renderer for the obstruction2d-o0 resampling visualizer bundle.
...
block, target surface) as a top-down 2D scene using kinder's pure
...
# World bounds for kinder/Obstruction2D-o0-v0 (from the env config). The figure
# size is the world extent, so dpi sets the pixel size: at dpi 300 the
